...
test.describe.serial("Chat App test", async ()=>{
    ...
    test("Quick text test on Multilingual sharedPage", async function({}){
        ...
        const quickTextMsg= await sharedPage.locator('.slds-popover > div:nth-child(2)').textContent();
        console.log("The quick text msg contains: "+ quickTextMsg);
